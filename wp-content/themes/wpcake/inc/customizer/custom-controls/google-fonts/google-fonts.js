jQuery( document ).ready(function($) {
	...
	$('.google-fonts-list').on('change', function() {
		...
		var indexes = $.map(bodyfontcontrol.wpcakefontslist, function(obj, index) {
		...
		$.each(bodyfontcontrol.wpcakefontslist[index].variants, function(val, text) {
		...
		$(this).parent().parent().find('.google-fonts-category').val(bodyfontcontrol.wpcakefontslist[index].category);

		wpcakeGetAllSelects($(this).parent().parent());
	});
	...
	function wpcakeGetAllSelects($element) {
		var selectedFont = {
